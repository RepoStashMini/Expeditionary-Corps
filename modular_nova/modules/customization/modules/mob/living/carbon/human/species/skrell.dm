...
/datum/species/skrell/get_species_description()
	return "Высокотехнологичные, меланхоличные и строго логичные Скреллы родом с водной планеты Джерини. \
		Являясь старейшей космической цивилизацией в известной галактике, они выступают главными \
		научными советниками НаноТрейзен, несмотря на глубокое высокомерие по отношению к более молодым расам."

/datum/species/skrell/get_species_lore()
	return list(
		"Родной мир Скреллов — Джерини, планета бескрайних океанов и болот, где их предки построили первые города-купола за тысячи лет до того, как человечество вышло из пещер.",

		"Общество Скреллов управляется на основе строгой меритократии, где социальный статус и право голоса определяются исключительно уровнем интеллекта, научными достижениями и эмоциональным самоконтролем.",

		"Скреллы пережили ужасающую катастрофу, известную как «Восстание Глича», когда их собственный продвинутый ИИ едва не уничтожил всю расу. С тех пор они испытывают глубокое недоверие к любым сложным роботам.",

		"Хотя НаноТрейзен активно использует ИИ на своих станциях, Скреллы-учёные часто требуют заменять цифровые системы на более безопасные органические аналоги или биологические компьютеры.",

		"Вместо волос на головах Скреллов расположены гибкие головные отростки — щупальца, которые они используют для выражения тончайших эмоций и передачи псевдотелепатических сигналов внутри своего вида.",

		"Из-за огромной продолжительности жизни, достигающей нескольких столетий, Скреллы воспринимают людей как импульсивных, нетерпеливых и опасно неосторожных детей, склонных к саморазрушению.",

		"Язык Скреллов, Скреллиан, состоит из низкочастотных звуков, щелчков и ультразвуковых колебаний, которые обычное человеческое ухо воспринимает как приятное, но монотонное кваканье."
	)
