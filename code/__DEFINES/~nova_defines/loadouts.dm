...
//Security.
#define ALL_JOBS_SEC JOB_WARDEN, JOB_DETECTIVE, JOB_SECURITY_OFFICER, JOB_HEAD_OF_SECURITY, JOB_SECURITY_OFFICER_MEDICAL, JOB_SECURITY_OFFICER_ENGINEERING, JOB_SECURITY_OFFICER_SCIENCE, JOB_SECURITY_OFFICER_SUPPLY, JOB_BLUESHIELD, JOB_VETERAN_ADVISOR,
//Nanotrasen and Centcom
#define ALL_JOBS_CC JOB_NT_REP,
//Medical
#define ALL_JOBS_MED JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_CHEMIST, JOB_PARAMEDIC, JOB_CORONER, JOB_VIROLOGIST, JOB_PSYCHOLOGIST,
//Science
#define ALL_JOBS_SCI JOB_SCIENTIST, JOB_ROBOTICIST, JOB_GENETICIST, JOB_RESEARCH_DIRECTOR, JOB_CHEMIST,
//Cargo
#define ALL_JOBS_CARGO JOB_QUARTERMASTER, JOB_CARGO_TECHNICIAN, JOB_SHAFT_MINER, JOB_BITRUNNER,
//Engineering
#define ALL_JOBS_ENGI JOB_CHIEF_ENGINEER, JOB_STATION_ENGINEER, JOB_ATMOSPHERIC_TECHNICIAN, JOB_TELECOMMS_SPECIALIST,
//Command
