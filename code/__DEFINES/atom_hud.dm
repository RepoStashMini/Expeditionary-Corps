...
#define SECHUD_FORWARDER "hudforwarder"
#define SECHUD_FORWARDER_PARAMEDIC "hudexpeditionarymedic"
#define SECHUD_FORWARDER_ENGINEE "hudexpeditionaryengineer"
#define SECHUD_JOB_EXP_MEDICAL_OFFICER "hudexpeditionarymedicalofficer"
