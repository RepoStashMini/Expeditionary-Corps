...
#define JOB_EXP_OFFICER "Expedition Officer"
//Silicon
#define JOB_AI "AI"
...
#define JOB_DISPLAY_ORDER_EXP_CORPS 411 //NOVA EDIT ADDITION // что это вообще??
...
#define DEPARTMENT_BITFLAG_EXPEDITIONARY (1<<11)
#define DEPARTMENT_EXPEDITIONARY "Expeditionary"
...
DEFINE_BITFIELD(departments_bitflags, list(
	...
	"EXPEDITIONARY" = DEPARTMENT_BITFLAG_EXPEDITIONARY,
